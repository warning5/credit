...
<div class="page">
	<div class="pageContent">
		<form method="post" action="agcFinacial_createAgcFinacial.action"
			...
			<div class="pageFormContent" layoutH="56">
				<p>
					<label>评级机构名称：</label>
					<input type="hidden" name="agcFinacial.agcId" value="${identity}"/> 
					<c:choose>
						<c:when test="${empty identity}">
							<input type="text" class="required"	name="agcFinacial.agcCnName" readonly="readonly" /> <a
								class="btnLook" href="agc_lookup.action" lookupGroup="agcFinacial"
								target="dialog" width="750" height="360" mask="true">查找带回</a>
						</c:when>
						<c:otherwise>
							<input type="text" class="required"	name="agcFinacial.agcCnName" readonly="readonly" value="${agcFinacial_agcCnName}"/>
						</c:otherwise>
					</c:choose>
				</p>
				<p>
				...
				<div class="unit">
					...
					<textarea name="agcFinacial.agcAccFirmOpin" class="required" cols="155" rows="7"></textarea>
				</div>
			</div>
			<div class="formBar">
				<ul>
